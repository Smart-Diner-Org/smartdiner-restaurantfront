    ...
    return (
      <div className="payment-method">
        <div className="row">
          <ul style={{ width: "100%" }}>
            <li>
              <button className="d-flex align-item-center">
                UPI Wallets
                <div
            ...
            <li>
              <button className="d-flex align-item-center">Credit Card</button>
            </li>
            <li>
              <button className="d-flex align-item-center">
                Debit card
            ...
            <li>
              <button className="d-flex align-item-center">Net Banking</button>
            </li>
            <li>
              <button className="d-flex align-item-center">
                Other Wallets
