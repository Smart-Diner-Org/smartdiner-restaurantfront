...
async componentDidMount() {  //API call to get data from backend
    try{
        await axios.get(`https://80b047bae3e5.ngrok.io/before_login/restaurant/get_full_details`)  //  https://80b047bae3e5.ngrok.io/before_login/restaurant/get_full_details  ./dbapi.json
      .then(res => {
        const data = res.data;
