    ...
    return (
      <div className="otpPage-container d-flex flex-column justify-content-center align-items-center">
        <img
          ...
          height="75"
          alt="logo"
          className="logo rounded-circle mt-50"
        ></img>
        <h3>{this.props.restuarantName}</h3>
        {/*<a href="#">Login</a>/<a href="#">Sign up</a> */}
        {!this.props.wrongOrder && (
          <p className="text-center mt-50">
            We have sent OTP to your given mobile number{" "}
            {this.props.customerContactNumber} please enter the OTP below
          </p>
        )}
        {this.props.wrongOrder && (
          <p className="text-center mt-50" style={{ color: "#e22a28" }}>
            {" "}
            {this.props.wrongOrder}
          </p>
        )}
          ...
          <>
            <div className="otp-box d-inline-flex justify-content-center ">
              ...
              <div className="d-flex align-items-center ">
                ...
                {this.props.seconds < 10
                  ...
                  : this.props.seconds}
                <strong style={{ color: "#000466", fontSize: "15px" }}>
            ...
            <div className="container  d-flex justify-content-center mt-20">
              {this.props.errorMessage ? (
                <small className="ml-1" style={{ color: "#e22a28" }}>
                  {this.props.errorMessage}
                </small>
              ) : (
                <small className="ml-1" style={{ color: "green" }}>
        ...
        <div className="contact-button mt-60 mb-50">
          <a
            href={`tel:+91${this.props.restaurantContactNumber}`}
            target="blank"
          >
            <button
              onClick={() => {
